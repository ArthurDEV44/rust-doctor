...
- [x] **Blog post technique** : "What rust-doctor catches that clippy alone misses" ✅
  - 5 sections avec code concret (hardcoded-secrets, blocking-in-async, block-on-in-async, unwrap, CVEs)
  - Incidents réels sourcés (Turso, GitGuardian 39M, RUSTSEC-2024-0003, CVE-2024-24576)
  - Data points (CodeRabbit 2.74x, Karpathy vibe coding, 78% AI usage)
  - Publié sur rust-doctor.dev/blog/what-rust-doctor-catches-that-clippy-misses
  - [ ] Cross-poster sur dev.to après le Show HN
- [x] **Vidéo terminal** du scan en action ✅
  - MP4 Remotion (728KB) dans `assets/demo.mp4`
  - Intégrée dans le README GitHub
  - [ ] Convertir en GIF pour les contextes où la vidéo ne se lit pas (Reddit, etc.)
...
- [ ] Upvoter quelques posts techniques
- [ ] Laisser 1-2 commentaires pertinents sur des threads Rust/tooling/dev
- [ ] Accumuler un peu de karma avant le Show HN
...
- [x] **Tweet en anglais** sur X (@arthurstrivex) ✅
  - Vidéo Remotion intégrée
  - https://x.com/arthurstrivex/status/2034583197975986581
